namespace DataAccessLayer.Migrations
{
    ...
    public partial class mig_writer_down : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Writers", "WriterAbout", c => c.String(maxLength: 200));
            AlterColumn("dbo.Writers", "WriterName", c => c.String(maxLength: 200));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.Writers", "WriterMail", c => c.String(maxLength: 20));
            AlterColumn("dbo.Writers", "WriterSurname", c => c.String(maxLength: 20));
            AlterColumn("dbo.Writers", "WriterName", c => c.String(maxLength: 20));
